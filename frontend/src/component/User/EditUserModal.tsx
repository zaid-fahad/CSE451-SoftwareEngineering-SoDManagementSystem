      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-xl w-full max-w-md overflow-hidden text-left animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="flex flex-col space-y-1.5 w-full text-left">
            <label htmlFor="editUserRole" className="text-xs font-semibold text-slate-700 uppercase tracking-wider">
              Assigned User Role
            </label>
            <select
              id="editUserRole"
              ...
              value={formData.role}
              onChange={handleChange}
              className="w-full bg-white text-slate-900 text-xs rounded-md p-2.5 border border-slate-300 focus:border-blue-600 outline-none cursor-pointer"
            >
